...
namespace ECommerceWebUi.Controllers
{
    ...
    public class AboutController : Controller
    {
        ...
        public async Task<IActionResult> CreateAbout(AboutCreateDto createAboutDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7028/api/About", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7028/api/About/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
