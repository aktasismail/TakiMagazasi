...
namespace ECommerceDataAccess.Migrations
{
    ...
    [Migration("20240218190526_cargotrackingcode")]
    partial class cargotrackingcode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceEntities.Comment", b =>
                {
            ...
            modelBuilder.Entity("ECommerceEntities.Favourite", b =>
                {
            ...
            modelBuilder.Entity("ECommerceEntities.Review", b =>
                {
            ...
            modelBuilder.Entity("ECommerceEntities.Comment", b =>
                {
                    ...
                    b.HasOne("ECommerceEntities.AppUser", "AppUser")
                        .WithMany()
                        .HasForeignKey("Uid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerceEntities.Product", b =>
                {
                    ...
                    b.HasOne("ECommerceEntities.Order", null)
                        .WithMany("Products")
